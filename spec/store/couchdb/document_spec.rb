...
# require File.dirname(__FILE__) + '/../../../lib/aqua/store/couch_db/document'
# 
# describe 'Aqua::Store::CouchDB::Document' do
#   before(:each) do 
#     Document = Aqua::Store::CouchDB::Document unless defined?( Document )
#     @db = Aqua::Store::CouchDB::Database.create('my_class')
#   end
#   
#   after(:each) do
#     @db.delete!
...
#       return_value.class.should == Aqua::Store::CouchDB::Document 
...
#       doc.class.should == Aqua::Store::CouchDB::Document
